...
static esp_err_t config_post_handler(httpd_req_t *req)
{
    ...
    JSON_TO_STRING(root, "url1",           cfg->api_url_1);
    JSON_TO_STRING(root, "url2",           cfg->api_url_2);
    JSON_TO_STRING(root, "url3",           cfg->api_url_3);
    JSON_TO_STRING(root, "ntp",            cfg->ntp_server);
    JSON_TO_INT   (root, "theme_index",    cfg->theme_index);
    JSON_TO_STRING(root, "filter_colors_1", cfg->filter_colors_1);
    JSON_TO_STRING(root, "filter_colors_2", cfg->filter_colors_2);
    JSON_TO_STRING(root, "filter_colors_3", cfg->filter_colors_3);
    JSON_TO_STRING(root, "rms_thresholds_1", cfg->rms_thresholds_1);
    JSON_TO_STRING(root, "rms_thresholds_2", cfg->rms_thresholds_2);
    JSON_TO_STRING(root, "rms_thresholds_3", cfg->rms_thresholds_3);
    JSON_TO_STRING(root, "hfr_thresholds_1", cfg->hfr_thresholds_1);
    JSON_TO_STRING(root, "hfr_thresholds_2", cfg->hfr_thresholds_2);
    JSON_TO_STRING(root, "hfr_thresholds_3", cfg->hfr_thresholds_3);
