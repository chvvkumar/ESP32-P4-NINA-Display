...
#define OTA_ACCENT      0x00D4FF
#define OTA_ACCENT_DIM  0x005566
...
void nina_ota_prompt_create(lv_obj_t *parent) {
    ...
    lv_obj_set_style_text_color(lbl_version, lv_color_hex(OTA_ACCENT), 0);
    ...
    lv_obj_set_height(notes_cont, 350);
    ...
    lv_obj_set_size(btn_skip, 200, 54);
    lv_obj_set_style_radius(btn_skip, 12, 0);
    ...
    lv_obj_set_style_text_font(lbl_skip, &lv_font_montserrat_18, 0);
    lv_obj_set_style_text_color(lbl_skip, lv_color_hex(0x999999), 0);
    lv_obj_center(lbl_skip);

    /* Update button — solid accent */
    btn_update = lv_button_create(btn_row);
    lv_obj_set_size(btn_update, 200, 54);
    lv_obj_set_style_radius(btn_update, 12, 0);
    lv_obj_set_style_bg_color(btn_update, lv_color_hex(OTA_ACCENT), 0);
    ...
    lv_obj_set_style_bg_color(btn_update, lv_color_hex(0x0099CC), LV_STATE_PRESSED);
    lv_obj_add_event_cb(btn_update, update_btn_cb, LV_EVENT_CLICKED, NULL);

    lv_obj_t *lbl_upd = lv_label_create(btn_update);
    lv_label_set_text(lbl_upd, "Update Now");
    lv_obj_set_style_text_font(lbl_upd, &lv_font_montserrat_18, 0);
    lv_obj_set_style_text_color(lbl_upd, lv_color_hex(0x000000), 0);
    ...
    lv_obj_set_style_text_color(lbl_percent, lv_color_hex(OTA_ACCENT), 0);
    ...
    lv_obj_set_style_bg_color(bar_glow, lv_color_hex(OTA_ACCENT), LV_PART_INDICATOR);
    ...
    lv_obj_set_style_bg_color(bar_progress, lv_color_hex(OTA_ACCENT_DIM), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(bar_progress, LV_OPA_30, LV_PART_MAIN);
    lv_obj_set_style_radius(bar_progress, 6, LV_PART_MAIN);
    lv_obj_set_style_bg_color(bar_progress, lv_color_hex(OTA_ACCENT), LV_PART_INDICATOR);
    lv_obj_set_style_bg_opa(bar_progress, LV_OPA_COVER, LV_PART_INDICATOR);
    lv_obj_set_style_bg_grad_color(bar_progress, lv_color_hex(0x0088FF), LV_PART_INDICATOR);
    lv_obj_set_style_bg_grad_dir(bar_progress, LV_GRAD_DIR_HOR, LV_PART_INDICATOR);
    ...
    lv_obj_t *err_title = lv_label_create(error_cont);
    lv_label_set_text(err_title, "Update Failed");
    lv_obj_set_style_text_font(err_title, &lv_font_montserrat_24, 0);
    lv_obj_set_style_text_color(err_title, lv_color_hex(0xFF4444), 0);
    ...
    lv_obj_set_size(btn_dismiss, 200, 54);
    ...
    lv_obj_t *lbl_dis = lv_label_create(btn_dismiss);
    lv_label_set_text(lbl_dis, "Dismiss");
    lv_obj_set_style_text_font(lbl_dis, &lv_font_montserrat_18, 0);
    lv_obj_set_style_text_color(lbl_dis, lv_color_hex(0x999999), 0);
...
void nina_ota_prompt_apply_theme(void) {
    ...
    /* Notes text */
    if (lbl_notes) {
        lv_obj_set_style_text_color(lbl_notes,
            lv_color_hex(app_config_apply_brightness(current_theme->text_color, gb)), 0);
    }

    /* Divider */
    if (divider) {
        lv_obj_set_style_bg_color(divider, lv_color_hex(current_theme->bento_border), 0);
    }

    /* Skip button */
    if (btn_skip) {
        lv_obj_set_style_border_color(btn_skip, lv_color_hex(current_theme->bento_border), 0);
    }
