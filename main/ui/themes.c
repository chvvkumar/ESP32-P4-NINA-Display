...
static const theme_t themes[] = {
    ...
    },
    {
        ...
        .bg_main = 0x000000,
        .bento_bg = 0x000508,
        .bento_border = 0x00363A,
        .label_color = 0x007C91,
        .text_color = 0xE0F7FA,
        .header_text_color = 0x4DD0E1,
        .header_grad_color = 0x001A1D,
        .target_name_color = 0xB2EBF2,
        .filter_text_color = 0x80DEEA,
    ...
    },
    {
        ...
        .bg_main = 0x000000,
        .bento_bg = 0x000000,
        .bento_border = 0x00E5FF,
        .label_color = 0x00B8D4,
        .text_color = 0xFFFFFF,
        .header_text_color = 0x00E5FF,
        .header_grad_color = 0x002A2A,
        .target_name_color = 0x18FFFF,
        .filter_text_color = 0x84FFFF,
