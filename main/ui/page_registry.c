 ...
 *
 * The static table below holds one entry per ASSIGNED page_ref id
 * (0..PAGE_REF_ID_MAX-1 minus the retired id 12), in id order. page_idx in the
 * table is the static mapping; the runtime-correct value is produced by
 * page_ref_resolve(), which folds in availability (and is the only path
 * callers should use to obtain a nav target).
 *
...
/* Static registry table — id order, one entry per assigned id (id 12 retired).
 * page_idx here is the static mapping; resolve() returns it after an
 * availability check. */
static const page_ref_entry_t s_pages[] = {
    /* id 0  */ { PAGE_REF_SUMMARY,          "summary",                "Summary",          PAGE_REF_KIND_PAGE,         PAGE_REF_SUMMARY,      true,  "NINA",    PAGE_IDX_SUMMARY                       },
    /* id 1  */ { PAGE_REF_NINA1,            "nina.1",                 "NINA 1",           PAGE_REF_KIND_PAGE,         PAGE_REF_NINA1,        true,  "NINA",    NINA_PAGE_OFFSET + 0                   },
    /* id 2  */ { PAGE_REF_NINA2,            "nina.2",                 "NINA 2",           PAGE_REF_KIND_PAGE,         PAGE_REF_NINA2,        true,  "NINA",    NINA_PAGE_OFFSET + 1                   },
    /* id 3  */ { PAGE_REF_NINA3,            "nina.3",                 "NINA 3",           PAGE_REF_KIND_PAGE,         PAGE_REF_NINA3,        true,  "NINA",    NINA_PAGE_OFFSET + 2                   },
    /* id 4  */ { PAGE_REF_SYSINFO,          "sysinfo",                "System Info",      PAGE_REF_KIND_PAGE,         PAGE_REF_SYSINFO,      true,  "System",  SYSINFO_PAGE_IDX(MAX_NINA_INSTANCES)   },
    /* id 5  */ { PAGE_REF_ALLSKY,           "allsky",                 "AllSky",           PAGE_REF_KIND_PAGE,         PAGE_REF_ALLSKY,       true,  "Dashboards", PAGE_IDX_ALLSKY                        },
    /* id 6  */ { PAGE_REF_SPOTIFY,          "spotify",                "Spotify",          PAGE_REF_KIND_PAGE,         PAGE_REF_SPOTIFY,      true,  "Dashboards", PAGE_IDX_SPOTIFY                       },
    /* id 7  */ { PAGE_REF_CLOCK,            "clock",                  "Clock",            PAGE_REF_KIND_PAGE,         PAGE_REF_CLOCK,        true,  "Dashboards", PAGE_IDX_CLOCK                         },
    /* id 8  */ { PAGE_REF_IMG_GOES,   "image.goes",   "GOES Satellite", PAGE_REF_KIND_IMAGE_SOURCE, PAGE_REF_IMG_GOES,   true, "Image", PAGE_IDX_IMG_GOES   },
    /* id 9  */ { PAGE_REF_IMG_MOON,   "image.moon",   "Moon",           PAGE_REF_KIND_IMAGE_SOURCE, PAGE_REF_IMG_MOON,   true, "Image", PAGE_IDX_IMG_MOON   },
    /* id 10 */ { PAGE_REF_IMG_SOLAR,  "image.solar",  "Solar",          PAGE_REF_KIND_IMAGE_SOURCE, PAGE_REF_IMG_SOLAR,  true, "Image", PAGE_IDX_IMG_SOLAR  },
    /* id 11 */ { PAGE_REF_IMG_CUSTOM, "image.custom", "Custom Image",   PAGE_REF_KIND_IMAGE_SOURCE, PAGE_REF_IMG_CUSTOM, true, "Image", PAGE_IDX_IMG_CUSTOM },
    /* id 12: RETIRED (image.default). Reserved, never reused; no table row. */
    /* id 13 */ { PAGE_REF_SETTINGS,         "settings",               "Settings",         PAGE_REF_KIND_PAGE,         PAGE_REF_SETTINGS,     false, "System",  SETTINGS_PAGE_IDX(MAX_NINA_INSTANCES)  },
    /* id 14 */ { PAGE_REF_OVL_GRAPH,        "overlay.graph",          "RMS/HFR Graph",    PAGE_REF_KIND_OVERLAY,      PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 15 */ { PAGE_REF_OVL_INFO_CAMERA,  "overlay.info.camera",    "Camera Details",   PAGE_REF_KIND_OVERLAY,      PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 16 */ { PAGE_REF_OVL_INFO_MOUNT,   "overlay.info.mount",     "Mount Details",    PAGE_REF_KIND_OVERLAY,      PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 17 */ { PAGE_REF_OVL_INFO_SEQUENCE,"overlay.info.sequence",  "Sequence Details", PAGE_REF_KIND_OVERLAY,      PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 18 */ { PAGE_REF_OVL_INFO_FILTER,  "overlay.info.filter",    "Filter Details",   PAGE_REF_KIND_OVERLAY,      PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 19 */ { PAGE_REF_OVL_INFO_AUTOFOCUS,"overlay.info.autofocus","Autofocus Details",PAGE_REF_KIND_OVERLAY,      PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 20 */ { PAGE_REF_OVL_INFO_IMAGESTATS,"overlay.info.imagestats","Image Statistics",PAGE_REF_KIND_OVERLAY,     PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 21 */ { PAGE_REF_OVL_INFO_SESSION, "overlay.info.session",   "Session Stats",    PAGE_REF_KIND_OVERLAY,      PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 22 */ { PAGE_REF_OVL_THUMBNAIL,    "overlay.thumbnail",      "Thumbnail",        PAGE_REF_KIND_OVERLAY,      PAGE_REF_ID_NINA_ANY,  false, "NINA",    -1                                     },
    /* id 23 */ { PAGE_REF_OVL_EVENTLOG,     "overlay.eventlog",       "Event Log",        PAGE_REF_KIND_OVERLAY,      PAGE_REF_SUMMARY,      false, "System",  -1                                     },
    /* id 24 */ { PAGE_REF_JSON,             "json",                   "JSON Display",     PAGE_REF_KIND_PAGE,         PAGE_REF_JSON,         true,  "Dashboards", PAGE_IDX_JSON                          },
    /* id 25 */ { PAGE_REF_HA,               "ha",                     "Home Assistant",   PAGE_REF_KIND_PAGE,         PAGE_REF_HA,           true,  "Dashboards", PAGE_IDX_HA                            },
...
bool page_ref_is_available(page_ref_t id)
{
    ...
    switch (id) {
        ...
        case PAGE_REF_IMG_GOES:   avail = c->goes_enabled;  break;
...
bool page_ref_resolve(page_ref_t id, int *page_idx_out)
{
    ...
    if (e->page_idx < 0) {          /* overlays have no nav target */
        return false;
    }
...
bool page_ref_navigate(page_ref_t id)
{
    ...
    if (!page_ref_resolve(id, &page_idx)) {
        return false;
    }
    /* USER-claim navigation. Caller must not hold the LVGL lock. */
    nav_arbiter_submit_user(page_idx, esp_timer_get_time() / 1000);
    return true;
}
