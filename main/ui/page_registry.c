...
static const page_ref_entry_t s_pages[] = {
    ...
    /* id 5  */ { PAGE_REF_ALLSKY,           "allsky",                 "AllSky",           PAGE_REF_KIND_PAGE,         PAGE_REF_ALLSKY,       true,  "Ambient", PAGE_IDX_ALLSKY                        },
    /* id 6  */ { PAGE_REF_SPOTIFY,          "spotify",                "Spotify",          PAGE_REF_KIND_PAGE,         PAGE_REF_SPOTIFY,      true,  "Ambient", PAGE_IDX_SPOTIFY                       },
    /* id 7  */ { PAGE_REF_CLOCK,            "clock",                  "Clock",            PAGE_REF_KIND_PAGE,         PAGE_REF_CLOCK,        true,  "Ambient", PAGE_IDX_CLOCK                         },
