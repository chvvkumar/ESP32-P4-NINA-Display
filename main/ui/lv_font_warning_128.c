 ...
 * Size: 128 px
 * Bpp: 4
 * Opts: --bpp 4 --size 128 --font MaterialIcons-Regular.ttf --range 0xE002 --format lvgl --no-compress -o main/ui/lv_font_warning_128.c
 ******************************************************************************/

#include "lvgl.h"
#include "lvgl_private.h"

#ifndef LV_FONT_WARNING_128
#define LV_FONT_WARNING_128 1
#endif

#if LV_FONT_WARNING_128
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 2048, .box_w = 118, .box_h = 102, .ofs_x = 5, .ofs_y = 16}
};
...
{
    {
        .range_start = 57346, .range_length = 1, .glyph_id_start = 1,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_warning_128 = {
#else
lv_font_t lv_font_warning_128 = {
#endif
