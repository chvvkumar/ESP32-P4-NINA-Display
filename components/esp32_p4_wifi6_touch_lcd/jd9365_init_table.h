/*
 * JD9365 vendor init sequence, shared by both round panels.
 *
 * Copied verbatim from the round BSP (Waveshare ESP32-P4-WIFI6-Touch-LCD-XC),
 * entries lines 79 to 295. The ONLY value that differs between the two round
 * panels is page-1 register 0x40: 0x00 on the 3.4 inch 800x800 and 0x04 on the
 * 4.0 inch 720x720.
 *
 * Deliberately NOT include-guarded: this file is included ONCE PER PANEL ROW,
 * with JD9365_TABLE_NAME and JD9365_REG40 defined by the includer, so each row
 * owns its own immutable table and nothing patches a byte at runtime.
 */

#if !defined(JD9365_TABLE_NAME) || !defined(JD9365_REG40)
#error "define JD9365_TABLE_NAME and JD9365_REG40 before including jd9365_init_table.h"
#endif

static const jd9365_lcd_init_cmd_t JD9365_TABLE_NAME[] = {
    ...
    {0x40, (uint8_t[]){JD9365_REG40}, 1, 0},   /* panel byte, per row */
